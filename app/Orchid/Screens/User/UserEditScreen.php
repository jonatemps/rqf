    ...
    public function layout(): array
    {
        return [
            ...
            Layout::block(UserEditLayout::class)
                ...
                ->description(__('Modifiez les information de votre profil et l\'adresse email.'))
                ->commands(
                    Button::make(__('Save'))
                        ->type(Color::DEFAULT())
                        ->icon('check')
            ...
            Layout::block(UserRoleLayout::class)
                ->title(__('Roles'))
                ->description(__('Un rôle définit un ensemble de tâches auxquelles un utilisateur attribué le rôle est autorisé à effectuer.'))
                ->commands(
                    Button::make(__('Save'))
                        ->type(Color::DEFAULT())
                        ->icon('check')
