...
class ServiceChartScreen extends Screen
{
    /**
     * Display header name.
     *
     * @var string
     */
    public $name = 'Statistiques Services';
    public $description = "L'essentiel des statistiques concernat les Services.";
    /**
     * Query data.
     *
     * @return array
    ...
    public function layout(): array
    {
        return [
            ...
            Layout::tabs([
                ...
                'Top Services Gourmands 2023' => Layout::table('table', [
                    TD::make('id', 'ID')
                        ->width('150')
                        ->render(function (Repository $model) {
                            // Please use view('path')
                ...
                'Top Services Gourmands 2024' =>Layout::table('table', [
                    TD::make('id', 'ID')
                        ->width('150')
                        ->render(function (Repository $model) {
                            // Please use view('path')
